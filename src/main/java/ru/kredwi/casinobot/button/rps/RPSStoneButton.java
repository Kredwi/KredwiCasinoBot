...
public class RPSStoneButton extends RPSAcceptButtons implements IButton {
	...
	private static final String BUTTON_ID = "rps_stone_button";
	
	@Override
	public Button getData() {
		return Button.primary(BUTTON_ID, "Rock");
	}

	@Override
	public Button getLozalizatedButton(String lang) throws LocaleKeyNotFound {
		String buttonName = MainLocale.getResource(lang, LocaleMessagesKeys.GAMES_RSP_BUTTON_ROCK);
		if (buttonName == null) {
			return this.getData();
		} else {
